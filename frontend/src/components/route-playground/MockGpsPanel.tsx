import type { ActionMode, LngLatTuple, MarkerPoint } from "../../types/navigation";
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 10, display: "flex", gap: 8, flexWrap: "wrap" }}>
        <button onClick={() => onModeChange("vehicle-simulation")} style={buttonStyle}>
          Teleport Vehicle
        </button>
        <button onClick={() => onModeChange("add-waypoint")} style={buttonStyle}>
          Add Waypoint
        </button>
        <button onClick={() => onModeChange("remove-marker")} style={buttonStyle}>
          Remove Waypoint
        </button>
      </div>
      ...
      <div style={{ marginTop: 12, fontSize: 13, fontWeight: 600 }}>Waypoints</div>
      <div style={{ marginTop: 8, display: "flex", flexDirection: "column", gap: 6 }}>
        {waypoints.length === 0 && (
          <div style={{ fontSize: 12, color: "#64748b" }}>No waypoints yet.</div>
        )}
